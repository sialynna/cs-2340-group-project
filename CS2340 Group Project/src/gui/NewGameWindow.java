...
public class NewGameWindow {
	...
	public NewGameWindow() {
		...
		initialize();
		this.frmApocalypseTrail.setVisible(true);
	}
	...
	private void initialize() {
		...
		frmApocalypseTrail.getContentPane().add(rationSelect);
		...
		frmApocalypseTrail.getContentPane().add(paceSelect);
		...
		frmApocalypseTrail.getContentPane().add(profSelect);
		...
		frmApocalypseTrail.getContentPane().add(memberSelect);
		...
		frmApocalypseTrail.getContentPane().add(label_1);
		...
		frmApocalypseTrail.getContentPane().add(label_2);
		
		btnStartGame = new JButton("Start Game!");
		btnStartGame.setBackground(Color.GRAY);
		btnStartGame.setBounds(305, 218, 117, 54);
		frmApocalypseTrail.getContentPane().add(btnStartGame);
		...
		leaderName.setBackground(Color.DARK_GRAY);
		frmApocalypseTrail.getContentPane().add(leaderName);
		...
		frmApocalypseTrail.getContentPane().add(lblHowManyOther);
		...
		member1name.setBackground(Color.DARK_GRAY);
		frmApocalypseTrail.getContentPane().add(member1name);
		...
		member2name.setBackground(Color.DARK_GRAY);
		frmApocalypseTrail.getContentPane().add(member2name);
		...
		member3name.setBackground(Color.DARK_GRAY);
		frmApocalypseTrail.getContentPane().add(member3name);
		...
		member4name.setBackground(Color.DARK_GRAY);
		frmApocalypseTrail.getContentPane().add(member4name);
		...
		frmApocalypseTrail.getContentPane().add(lblMember_1);
		...
		frmApocalypseTrail.getContentPane().add(lblMember_2);
		...
		frmApocalypseTrail.getContentPane().add(lblMember_3);
		...
		frmApocalypseTrail.getContentPane().add(lblMember_4);
		...
		frmApocalypseTrail.getContentPane().add(lblInitialPace);
		...
		frmApocalypseTrail.getContentPane().add(lblInitialRations);
		...
		frmApocalypseTrail.getContentPane().add(namelabelBackground);
		...
		frmApocalypseTrail.getContentPane().add(memberselectBack);
		...
		frmApocalypseTrail.getContentPane().add(paceBack);
		...
		frmApocalypseTrail.getContentPane().add(rationsBack);
		...
		frmApocalypseTrail.getContentPane().add(mem_1_back);
		...
		frmApocalypseTrail.getContentPane().add(mem_2_back);
		...
		frmApocalypseTrail.getContentPane().add(mem_3_back);
		...
		frmApocalypseTrail.getContentPane().add(mem_4_back);
		
		label = new JLabel("New label");
		label.setBounds(316, 23, 61, 16);
		frmApocalypseTrail.getContentPane().add(label);
		...
		frmApocalypseTrail.getContentPane().add(noname);
