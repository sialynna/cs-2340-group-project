 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Christopher Whittemore");
		  toPrint += p1.toString("gtg063i");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Jay Zuerndorfer");
		  toPrint += p2.toString("jzuerndorfer3");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Jeffrey Zhang");
		  toPrint += p3.toString("jzhang74");
